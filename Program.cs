...
namespace List
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            personList.Add(new Person(1234, "Mohammed", "Male", 32));
            personList.Add(new Person(5678, "Ahmed", "Male", 20));
            personList.Add(new Person(8910, "Fatema", "Female", 25));
            foreach (Person person in personList)
            {
                Console.WriteLine($"Id: {person.Id}, Name: {person.Name}, Gender: {person.Gander}, Age:  {person.Age}");
                Console.WriteLine("--------------------------");
            }
